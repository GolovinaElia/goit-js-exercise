...
//     проверяет её на содержание запрещённых слов spam и sale, и
// возвращает результат проверки.Слова в строке параметра message могут быть
...
function checkForSpam(message) {
  ...
  result = message.toLowerCase();
   result = (result.includes('sale') || result.includes('spam'));
