...
// Объяви переменную totalPrice для хранения общей суммы заказа
// и присвой ей выражение расчёта этой суммы.
...
// переменную message сообщение: 'Вы купили <число> дроидов, на счету осталось 
//     < число > кредитов'.
// Тесты
...
let totalPrice = pricePerDroid * orderedQuantity;
  if (totalPrice > customerCredits) {
     ...
     totalPrice = customerCredits - (pricePerDroid * orderedQuantity);
message = `Вы купили ${orderedQuantity} дроидов, на счету осталось ${totalPrice} кредитов`;
    }
