...
// Добавим классу пользователя приватное свойство
//  type - его тип, определяющий набор прав, например
//  администратор, редактор, просто пользователь и т п.
...
//  Для этого имя свойства должно начинаться с
//  символа #, также как приватные свойства.
...
// У экземпляра класса Car вызов сеттера price,
//  со значением аргумента меньше чем значение MAX_PRICE, изменяет свойство #price.
// У экземпляра класса Car вызов сеттера price,
//  со значением аргумента больше чем значение MAX_PRICE, не изменяет свойство #price.
