// Магазин по продаже ремонтных дроидов готов к открытию, осталось
// написать скрипт для их заказа.Объяви переменные и присвой им
...
// Значение переменной message это строка 'Вы заказали дроидов на сумму 
// 4850 кредитов.
