...
// Якщо жодного збігу значень не відбулося,
//  необхідно виконати код за замовчуванням,
//  як у блоці else для інструкції if...else.
...
//  оскільки це і так останнє, що буде виконано в
//  switch і управління буде передане коду після нього.

// Функція checkPassword(password) отримує пароль
//  в параметр password, перевіряє його на збіг з
