...
// Тут результатом теж буде true, оскільки хоча
//  б один з операндів, у цьому випадку правий, був приведений до true.
...
// Тобто логічне «АБО» запинається на істині і повертає
//  те, на чому запнулося або останній операнд.
...
//  Отримати доступ можуть тільки користувачі
//  з передплатою pro або vip.

// Присвой змінній canAccessContent вираз перевірки передплати.
//  Якщо значення параметра subType дорівнює рядкам "pro"
//  або "vip", користувач отримає доступ. Результатом виразу перевірки буде буль true або false.
