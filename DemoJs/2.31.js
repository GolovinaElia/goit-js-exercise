...
// Якщо цикл знаходиться в тілі функції,
//  то оператор break не припиняє виконання
//  функції, а тільки перерве цикл.
//  Для того щоб переривати виконання відразу циклу і функції, є оператор return.

// У прикладі шукаємо число 3.
//  Щойно виконається умова if, робимо повернення, яке перерве виконання циклу і функції.
