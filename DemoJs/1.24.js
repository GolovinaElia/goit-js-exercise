...
// Функція getDiscount(totalSpent)
//  визначає значення знижки, залежно
//  від загальної суми витрачених грошей
//  (параметр totalSpent) в магазині за весь час
//  (партнерська програма). Знижка записується у змінну discount і повертається з функції як результат її роботи.
...
// Значення знижок кожного рівня зберігаються
//  в однойменних константах BASE_DISCOUNT, BRONZE_DISCOUNT, SILVER_DISCOUNT і GOLD_DISCOUNT.
