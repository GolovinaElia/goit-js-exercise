// МЕТОД INCLUDES()
// Метод рядків includes(substring) перевіряє,
//  чи входить підрядок substring у рядок,
//  повертає буль - true, якщо входить,
...
//  та повертає буль true або false - результат перевірки входження підрядка name у рядок fullname.
...
// Присвой змінній result вираз перевірки входження імені
//  (параметр name), у повне ім'я (параметр fullname).
