...
// Функція makeTransaction(pricePerDroid, orderedQuantity,
//  customerCredits) виконує транзакцію з продажу дроїдів
//  і повертає повідомлення про результат операції. Вона оголошує три параметри,
...
//  у змінну message повідомлення: "You ordered <число> droids, you have <число> credits left".
