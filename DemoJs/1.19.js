...
//  який виконається тільки у разі, коли жодна з умов не приведеться до true.
...
// За першої ж задовільної умови перевірки припиняться і
//  виконається тільки тіло відповідного блоку if.
//  Тому подібний запис потрібно читати як: «шукаю перше виконання умови, ігнорую все інше».

// Функція checkPassword(password) отримує пароль
//  користувача в параметр password, перевіряє його
//  на збіг з паролем адміністратора у змінній ADMIN_PASSWORD
...
//  значить користувач скасував операцію і в message
