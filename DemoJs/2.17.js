// ЦИКЛ FOR
// Цикли використовуються для багаторазового
//  повторення коду. Оголошення циклу for складається з трьох виразів.
...
// Умова - вираз, що оцінюється перед кожною ітерацією
//  (повторенням) циклу. Тіло циклу виконується тільки
//  тоді, коли вираз приводиться до true. Цикл завершується,
//  якщо значення буде false.
// Пост-вираз - виконується в кінці кожного повторення циклу,
//  перед перевіркою умови. Використовується для оновлення
//  змінної-лічильника.
...
//  і цикл виконується (його тіло) доти, доки i <= 20, тобто
